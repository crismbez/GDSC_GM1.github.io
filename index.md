...
# Información de la sesión y referencias
    ...
    ##  [5] purrr_1.2.0     readr_2.1.6     tidyr_1.3.1     tibble_3.2.1   
    ##  [9] tidyverse_2.0.0 ggplot2_3.5.1   dplyr_1.1.4     readxl_1.4.5   
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] gtable_0.3.6      compiler_4.4.3    tidyselect_1.2.1  scales_1.3.0     
    ##  [5] yaml_2.3.10       fastmap_1.2.0     R6_2.6.1          labeling_0.4.3   
    ##  [9] generics_0.1.4    munsell_0.5.1     pillar_1.10.1     tzdb_0.5.0       
    ## [13] rlang_1.1.5       stringi_1.8.7     xfun_0.54         timechange_0.3.0 
    ## [17] cli_3.6.4         withr_3.0.2       magrittr_2.0.3    digest_0.6.37    
    ## [21] grid_4.4.3        rstudioapi_0.17.1 hms_1.1.4         lifecycle_1.0.4  
    ## [25] vctrs_0.6.5       evaluate_1.0.5    glue_1.8.0        farver_2.1.2     
    ## [29] cellranger_1.1.0  colorspace_2.1-1  rmarkdown_2.30    tools_4.4.3      
