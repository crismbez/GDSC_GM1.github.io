...
```{r cargar dataset, echo= FALSE, warning=FALSE, message=FALSE}
#Cargamos los datos y los asignamos a un objeto
library(readxl)
...
```{r visualización y comprobación dataset, echo=FALSE, warning=FALSE, message=FALSE, include=FALSE}
...
```{r procesado de los datos, echo=FALSE, warning=FALSE, message=FALSE}
...
El gráfico boxplot proporciona un representación visual de esto, ya que podemos observar como el Doramapimod presenta valores de AUC más bajos que el inhibidor VIII de JNK, por lo que el primero presentaría niveles de sensibilidad celular superiores.
